...
class StockDailyBasic(models.Model):
    ...
    total_share = models.BigIntegerField(null=True, blank=True, verbose_name='总股本(万股)')
    float_share = models.BigIntegerField(null=True, blank=True, verbose_name='流通股本(万股)')
    free_share = models.BigIntegerField(null=True, blank=True, verbose_name='自由流通股本(万)')
    total_mv = models.BigIntegerField(null=True, blank=True, verbose_name='总市值(万元)')
    circ_mv = models.BigIntegerField(null=True, blank=True, verbose_name='流通市值(万元)')
...
class StockDailyData(models.Model):
    ...
    open_qfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='开盘价（前复权）')
    high_qfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='最高价（前复权）')
    low_qfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='最低价（前复权）')
    close_qfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='收盘价（前复权）')
    pre_close_qfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='昨收价（前复权）')
    open_hfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='开盘价（后复权）')
    high_hfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='最高价（后复权）')
    low_hfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='最低价（后复权）')
    close_hfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='收盘价（后复权）')
    pre_close_hfq = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='昨收价（后复权）')
...
class StockMinuteData(models.Model):
    ...
    def __str__(self):
        return f"{self.stock_id} {self.trade_time} {self.freq}"
...
class StockWeeklyData(models.Model):
    ...
    close = models.DecimalField(max_digits=10, decimal_places=3, verbose_name='周收盘价')
    pre_close = models.DecimalField(max_digits=10, decimal_places=3, verbose_name='上一周收盘价')
    change = models.DecimalField(max_digits=10, decimal_places=3, verbose_name='周涨跌额')
    pct_chg = models.DecimalField(max_digits=6, decimal_places=2, verbose_name='周涨跌幅')
    vol = models.BigIntegerField(verbose_name='周成交量')
    amount = models.DecimalField(max_digits=20, decimal_places=3, verbose_name='周成交额')
...
class StockMonthlyData(models.Model):
    ...
    close = models.DecimalField(max_digits=10, decimal_places=3, verbose_name='月收盘价')
    pre_close = models.DecimalField(max_digits=10, decimal_places=3, verbose_name='上月收盘价')
    change = models.DecimalField(max_digits=10, decimal_places=3, verbose_name='月涨跌额')
