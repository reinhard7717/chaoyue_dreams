    ...
    try:
        ...
        for i in range(0, total_favorite_stocks, batch_size):
            ...
            if batch:
                ...
                # 使用新的批量任务，并指定队列
                save_realtime_data_batch.s(batch).set(queue="favorite_save_api_data_RealTime").apply_async()
        ...
        for i in range(0, total_non_favorite_stocks, batch_size):
            ...
            if batch:
                ...
                # 使用新的批量任务，并指定队列
                save_realtime_data_batch.s(batch).set(queue="save_api_data_RealTime").apply_async()
                total_dispatched_batches += 1
