...
def save_ths_index_member_task(self):
    ...
    result_member = async_to_sync(industry_dao.save_ths_index_member)()
...
def save_ths_index_yesterday_task(self):
    ...
    result_list = async_to_sync(industry_dao.save_ths_index_list)()
    ...
    result_daily = async_to_sync(industry_dao.save_ths_index_daily_by_trade_date)(trade_date=yesterday)
...
def save_ths_index_history_task(self):
    ...
    trade_days = async_to_sync(index_dao.get_last_n_trade_cal_open)()
    for day in trade_days:
        result_daily = async_to_sync(industry_dao.save_ths_index_daily_by_trade_date)(trade_date=day)
...
def save_ths_index_this_week_task(self):
    ...
    result_daily = async_to_sync(industry_dao.save_ths_index_daily_history)(start_date=this_monday, end_date=this_friday)
