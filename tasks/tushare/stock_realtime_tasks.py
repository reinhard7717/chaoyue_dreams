...
#  ================ 实时(分钟)数据任务 ================
@celery_app.task(bind=True, name='tasks.tushare.stock_realtime_tasks.save_minute_data_realtime_batch')
...
# --- 修改后的调度器任务 ---
@celery_app.task(bind=True, name='tasks.tushare.stock_realtime_tasks.save_stocks_minute_data_realtime_task')
