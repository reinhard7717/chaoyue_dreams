...
#  ================ 周线数据任务（当日） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_week_data_today_task', queue='SaveData_TimeTrade')
...
#  ================ 周线数据任务（昨日） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_week_data_yesterday_task', queue='SaveData_TimeTrade')
...
#  ================ 月线数据任务（当日） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_month_data_today_task', queue='SaveData_TimeTrade')
...
#  ================ 月线数据任务（昨日） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_month_data_yesterday_task', queue='SaveData_TimeTrade')
...
#  ================ 分钟数据任务 ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_minute_data_this_week_batch', queue='SaveData_TimeTrade')
...
#  ================ 日线数据任务 ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_day_data_this_week_batch', queue='SaveData_TimeTrade')
...
#  ================ 分钟数据任务（历史） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_minute_data_history_batch', queue='SaveData_TimeTrade')
...
#  ================ 日线数据任务（历史） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_day_data_history_batch', queue='SaveData_TimeTrade')
...
#  ================ 每日基本信息数据任务（历史） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_basic_data_history_batch', queue='SaveData_TimeTrade')
...
#  ================ 历史(月线)数据任务 ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_month_data_history_batch', queue='SaveData_TimeTrade')
