...
# ============== 每日筹码分布任务（当日） ==============
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_cyq_chips_today_batch', queue='SaveHistoryData_TimeTrade')
...
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_cyq_perf_today_batch', queue='SaveHistoryData_TimeTrade')
...
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_cyq_perf_yesterday_batch', queue='SaveHistoryData_TimeTrade')
...
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_cyq_perf_this_week_batch', queue='SaveHistoryData_TimeTrade')
...
#  ================ 分钟数据任务（历史） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_minute_data_history_batch', queue='SaveHistoryData_TimeTrade')
...
#  ================ 日线数据任务（历史） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_day_data_history_batch', queue='SaveHistoryData_TimeTrade')
...
#  ================ 每日基本信息数据任务（历史） ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_basic_data_history_batch', queue='SaveHistoryData_TimeTrade')
...
#  ================ 历史(月线)数据任务 ================
@celery_app.task(bind=True, name='tasks.tushare.stock_time_trade_tasks.save_month_data_history_batch', queue='SaveHistoryData_TimeTrade')
