...
from tasks.tushare.fund_flow_tasks import save_fund_flow_daily_data_ths_today, save_fund_flow_daily_data_today
from tasks.tushare.index_tasks import save_index_daily_basic_today
from tasks.tushare.stock_time_trade_tasks import save_day_data_today_task, save_stocks_daily_basic_data_today_task, save_stocks_minute_data_today_task  # 从 celery.py 导入 app 实例并重命名为 celery_app
...
def run_daily_data_ingestion_task(self, trade_time_str=None):
    ...
    try:
        ...
        save_index_daily_basic_today.delay()
