...
class TacticEngine:
    ...
    def synthesize_prime_tactic(self, df: pd.DataFrame) -> Dict[str, pd.Series]:
        ...
        has_energy_advantage = self._fuse_multi_level_scores(df, 'DYN_BULLISH_RESONANCE') > 0.7
    ...
    def _diagnose_pullback_tactics_matrix(self, df: pd.DataFrame, enhancements: Dict) -> Dict[str, pd.Series]:
        ...
        ff_resonance_score = self._fuse_multi_level_scores(df, 'FF_BULLISH_RESONANCE')
        ...
        is_reversal_confirmed = self._fuse_multi_level_scores(df, 'BEHAVIOR_BOTTOM_REVERSAL') > 0.5
    ...
    def synthesize_squeeze_playbooks(self, df: pd.DataFrame) -> Dict[str, pd.Series]:
        ...
        platform_quality_score = self._fuse_multi_level_scores(df, 'STRUCTURE_BULLISH_RESONANCE')
