...
def transmute_health_to_ultimate_signals(
    ...
    """
    【V3.0 · 阿瑞斯之矛协议版】终极信号中央合成引擎
    - 核心革命: 签署“阿瑞斯之矛协议”，为“底部反转”信号引入位置过滤器。
    - 新核心逻辑:
      1. 底部反转分 = (原始反转分) * bottom_context_score。
      2. 确保只有在价格处于长期底部区域时，动态拐点才会被认定为“底部反转”。
    - 收益: 彻底解决了系统将“上涨中继加速”误判为“底部反转”的致命逻辑缺陷。
    """
    states = {}
    # --- 1. 获取通用参数和上下文信号 ---
