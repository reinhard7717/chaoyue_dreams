...
CELERY_TASK_QUEUES = (
    ...
    Queue('Train_LSTM_Prepare_Data', routing_key='Train_LSTM_Prepare_Data.#'), # 机器学习 - 准备数据队列
    Queue('Train_LSTM', routing_key='Train_LSTM.#'), # 机器学习 - 训练队列
    Queue('favorite_Train_LSTM', routing_key='favorite_Train_LSTM.#'), # 计算股票指标队列
